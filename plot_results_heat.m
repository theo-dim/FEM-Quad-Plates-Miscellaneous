...
function plot_results_heat(type,xn,f,Idb,Ucomp,Rcomp,ien,nel,nen,nsd,ndf,nnp);
...
if (nen == 3)
    for e=1:nel,
        ...
        X(e,:,:)=[[xn(1,node(1)) xn(1,node(3))+1e-5];[xn(1,node(2)) xn(1,node(3))]];
        Y(e,:,:)=[[xn(2,node(1)) xn(2,node(3))+1e-5];[xn(2,node(2)) xn(2,node(3))]];
